    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cost', models.FloatField(blank=True, db_column='Cash', null=True)),
                ...
                ('payment_method', models.CharField(blank=True, db_column='PaymentMethod', max_length=10, null=True)),
                ('checkined_user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='checkin_user', to=settings.AUTH_USER_MODEL)),
                ('checkouted_user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='checkout_user', to=settings.AUTH_USER_MODEL)),
                ('customer_id', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='SystemApp.customers')),
                ...
                ('subcription', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='SystemApp.subscriptions')),
            ],
            options={
                'db_table': 'ParkingLog',
            },
